...
const Navbar = () => {
  ...
  return (
    <nav className='nav-body z-20 flex justify-between pl-5 pr-5 items-center text-white bg-black sticky top-0' ref={navbarRef}>
      <i onClick={() => naviagte("/")} className='logo-icon w-16 h-full cursor-pointer bg-center bg-cover bg-no-repeat '></i>
      ...
      <nav style={nav2 ? { display: "flex" } : { display: "none" }} className='nav-2-body absolute items-center justify-center bg-black' id='nav-2-body'>
        <div className='nav-2-items flex flex-col items-center justify-evenly' >

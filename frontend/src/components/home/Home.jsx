  ...
  return (
    <div className='home-body h-auto'>
      ...
      <div className='get-started-body h-auto flex flex-col justify-evenly items-center  pt-5 pb-5 gap-5'>
        <h2 className='font-extrabold h-auto w-full text-center text-white rounded-md'>Getting Started</h2>
      ...
      <div className='whatWeOffer-body h-auto pt-5 flex flex-col gap-5 pb-5 items-center'>
        <h1 className=' text-center text-white rounded-md'>What we offer</h1>
        <div className='whatWeOffer-block flex justify-evenly flex-wrap gap-4'>
          {
            cardData.map((v, i) => {
      ...
      <div className='review-body flex flex-col justify-evenly items-center'>
        <h2 className='text-center  text-white rounded-md'>People connected with US...</h2>
      ...
      })} className=' bg-blue-500 h-9 text-center grid items-center text-white cursor-pointer'>Scroll To Top</aside>
      <Footer></Footer>
